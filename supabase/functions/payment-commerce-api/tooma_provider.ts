...
function notConfigured(): never {
  throw new PaymentError(
    ...
    "Tooma Pay integration requires official API documentation and credentials",
    501,
  );
}

export class ToomaPaymentProvider implements PaymentProvider {
  readonly name = "tooma";
