-- =============================================================================
-- M2 Destiny OS — Dashboard SQL Editor one-paste (destiny-os ONLY)
...
-- Contains: inventory schema + RLS + sensitive stubs + destiny-media storage policies
...
-- >>> BEGIN 20260908143000_destiny_inventory_schema.sql
...
-- >>> BEGIN 20260908170000_destiny_media_storage_policies.sql
