...
-- Prefer destiny-media/...; fall back to legacy uploads path if media missing
BEGIN;
...
', 1480.0, 'USD', '7 NIGHTS 8 DAYS', false, true, 'destiny-media/tours/39/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
', 2780.0, 'USD', '5 NIGHTS 6 DAYS', false, true, 'destiny-media/tours/37/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
RATE', 5600.0, 'USD', '7 NIGHTS 8 DAYS', false, true, 'destiny-media/tours/36/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
DO NOT BRING DRINKS', 95.0, 'USD', 'DAY', false, true, 'destiny-media/tours/35/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
NOTE: PACKAGE RATES ARE SUBJECTED TO FLUCTUATIONS', 4610.0, 'USD', 'N/A', false, true, 'destiny-media/tours/34/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
HOUSEBOAT CRUISE
ACTVITIES 
HORSE RIDING FOR ADULTS', 40.0, 'USD', 'DAY', false, true, 'destiny-media/tours/33/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (32, 'ZAMBEZI ARK CRUISES', 'USD75 INCLUDING PARKING SPCE ', 75.0, 'USD', 'N/A', false, true, 'destiny-media/tours/32/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (30, 'Zanzibar (Beaches &amp; Island Escapes)', 'Flights from $590', 590.0, 'USD', '5', false, true, 'destiny-media/tours/30/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
Book by 12 Jul 2026; travel 25 Jun–30 Sept 2026.', 0.0, 'USD', 'Stopover offer', false, true, 'destiny-media/tours/29/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (15, 'Israel Holy Land Tour', 'A spiritual journey to the Holy Land. Includes VISA, return flights, all meals, 7 nights accommodation, and all tours and transfers.', 3023.0, 'USD', '8 Days, 7 Nights', true, true, 'destiny-media/tours/15/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (17, 'Malawi Trip', 'Includes 3 nights @ Sunbird Hotel, Breakfast, Hotel transfer, Boat cruise, Jet ski, and Return flights.', 1530.0, 'USD', '4 Days, 3 Nights', true, true, 'destiny-media/tours/17/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (18, 'Durban to Mozambique Cruise', '15 - 19 December 2025. Durban >> Pomene >> back to Durban. Includes return flight, 4 days accommodation, and all meals.', 1219.0, 'USD', '5 Days, 4 Nights', true, true, 'destiny-media/tours/18/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (19, 'Explore Singapore', '5 nights 6 days till 31st Sept 2025. Includes return flights, 5 nights accommodation, daily breakfast, Singapore City Tour, Wings Of Time with Cable Car, Madame Tussauds, Marina Bay Sands Sky Park, and all tours/transfers.', 1932.0, 'USD', '6 Days, 5 Nights', true, true, 'destiny-media/tours/19/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (20, 'Archipelago Resort Summer Escape', '3 nights bed and breakfast including return flights. Stay in spacious self-catering casas, dine at our seaside restaurant, dive, island-hop, or unwind.', 1150.0, 'USD', '4 Days, 3 Nights', false, true, 'destiny-media/tours/20/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (22, 'Girls Game Drive Retreat Kariba', 'August 10 to 11. Includes 1 night accommodation @ Spurwing Island, all meals, game drive, national park entry fees. *Excludes transport*.', 190.0, 'USD', '2 Days, 1 Night', false, true, 'destiny-media/tours/22/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (23, 'Musumu River Lodge Binga Tour', '2 nights 3 days (9 - 11 August). Includes breakfast and dinner, half-day guided tour, Tonga Museum, crocodile breeding, natural hot springs, sunset cruise. *Excludes transport*.', 460.0, 'USD', '3 Days, 2 Nights', false, true, 'destiny-media/tours/23/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (14, 'Kadoma Music Festival 2025', 'Catch Africa''s best, Diamond Platnumz, blasting the stage with Zimbabwe''s own legends Alick Macheso, Winky D, Jah Prayzah, Saintfloew and Gemma Griffiths', 20.0, 'USD', '1 Night', true, true, 'destiny-media/tours/14/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (1, 'Victoria Falls Adventure', 'Experience the thrill of the mighty Victoria Falls. This package includes a guided tour of the falls, a sunset cruise on the Zambezi River, and a visit to a local craft market.', 1250.0, 'USD', '3 Days, 2 Nights', false, true, 'destiny-media/tours/1/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (2, 'Durban To Mozambique Cruise', '"Embark on an unforgettable coastal odyssey with MSC. Book with us for a 5-day Durban to Mozambique cruise (Dec 15-19) and discover tropical bliss, vibrant cultures, and breathtaking scenery. Unleash your wanderlust!', 1219.0, 'USD', '3 Days, 1 Night', true, true, 'destiny-media/tours/2/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (3, 'Hwange National Park Safari', 'Embark on an unforgettable wildlife safari in Zimbabwe''s largest national park. Search for the Big Five and enjoy the pristine African bush.', 1800.0, 'USD', '4 Days, 3 Nights', false, true, 'destiny-media/tours/3/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/39/primary.webp', 'uploads/6a4f9a97e9470-615724801_1664832577822577_6837233941983207803_n.jpg', 0 FROM public.tours WHERE legacy_id=39;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/37/primary.webp', 'uploads/6a4f54675bd28-ChatGPT Image Jul 9, 2026, 09_56_32 AM.png', 0 FROM public.tours WHERE legacy_id=37;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/36/primary.webp', 'uploads/6a4f5295f1894-ChatGPT Image Jul 9, 2026, 09_49_04 AM.png', 0 FROM public.tours WHERE legacy_id=36;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/35/primary.webp', 'uploads/6a4e176be2915-655699898_1724774848495016_9085784168804663092_n.jpg', 0 FROM public.tours WHERE legacy_id=35;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/34/primary.webp', 'uploads/6a4e16b7113b4-659017522_1724776148494886_653600608863616191_n.jpg', 0 FROM public.tours WHERE legacy_id=34;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/33/primary.webp', 'uploads/6a4e14e4cf46c-657364419_1724779385161229_2149096553167828688_n.jpg', 0 FROM public.tours WHERE legacy_id=33;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/32/primary.webp', 'uploads/6a4e09e9e45cc-700499814_1768197580819409_6381454881535599423_n.jpg', 0 FROM public.tours WHERE legacy_id=32;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/31/primary.webp', 'uploads/6a4e08b9d25a3-710739115_1781943649444802_2817451762723528287_n.jpg', 0 FROM public.tours WHERE legacy_id=31;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/30/primary.webp', 'uploads/6a4e06df711f2-735150058_1811822186456948_101665622254047033_n.jpg', 0 FROM public.tours WHERE legacy_id=30;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/29/primary.webp', 'uploads/6a4e0663112ef-742045552_1817725842533249_6048909638074682386_n (1).jpg', 0 FROM public.tours WHERE legacy_id=29;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/15/primary.webp', 'uploads/IMG-20250908-WA0000.jpg', 0 FROM public.tours WHERE legacy_id=15;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/16/primary.webp', 'uploads/IMG-20250902-WA0003.jpg', 0 FROM public.tours WHERE legacy_id=16;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/17/primary.webp', 'uploads/IMG-20251016-WA0000.jpg', 0 FROM public.tours WHERE legacy_id=17;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/18/primary.webp', 'uploads/IMG-20251004-WA0008.jpg', 0 FROM public.tours WHERE legacy_id=18;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/19/primary.webp', 'uploads/IMG-20251004-WA0014.jpg', 0 FROM public.tours WHERE legacy_id=19;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/20/primary.webp', 'uploads/IMG-20251024-WA0006.jpg', 0 FROM public.tours WHERE legacy_id=20;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/22/primary.webp', 'uploads/IMG-20250902-WA0008.jpg', 0 FROM public.tours WHERE legacy_id=22;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/23/primary.webp', 'uploads/IMG-20250902-WA0009.jpg', 0 FROM public.tours WHERE legacy_id=23;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/14/primary.webp', 'uploads/68e49bd28aec3-kadomamusicfestival.jpg', 0 FROM public.tours WHERE legacy_id=14;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/14/gallery-01.webp', 'uploads/68e49c71927a8-kadoma2.gif', 1 FROM public.tours WHERE legacy_id=14;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/14/gallery-02.webp', 'uploads/68e49c7192afd-freekadoma.jpg', 2 FROM public.tours WHERE legacy_id=14;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/1/primary.webp', 'uploads/68c21f8416dbc-vic1.jpeg', 0 FROM public.tours WHERE legacy_id=1;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/1/gallery-01.webp', 'uploads/68c21f8416ea4-vic 2.jpeg', 1 FROM public.tours WHERE legacy_id=1;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/1/gallery-02.webp', 'uploads/68c21f8416f15-vic3.jpeg', 2 FROM public.tours WHERE legacy_id=1;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/1/gallery-03.webp', 'uploads/68c21f8416f7e-vic 4.jpeg', 3 FROM public.tours WHERE legacy_id=1;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/2/primary.webp', 'uploads/68e4a7c27c9a3-durbanmozambiquecruise.jpg', 0 FROM public.tours WHERE legacy_id=2;
...
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/3/primary.webp', 'uploads/68c21fce2c93b-gone3.jpeg', 0 FROM public.tours WHERE legacy_id=3;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/3/gallery-01.webp', 'uploads/68c21fce2ca63-gon2.jpeg', 1 FROM public.tours WHERE legacy_id=3;
INSERT INTO public.tour_images (tour_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/tours/3/gallery-02.webp', 'uploads/68c21fce2cafd-gone1.jpeg', 2 FROM public.tours WHERE legacy_id=3;
...
THAI INSURANCE
FLIGHTS INCLUDED', 'BANGKOK', 'BANGKOK', 'THAILAND', false, true, 'destiny-media/stays/37/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
GAME DRIVE', '', '', 'ZIMBABWE', false, true, 'destiny-media/stays/36/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
GAME DRIVE
HORSE RIDING
ELEPHANT INTERACTION', 'Selous, Mashonaland West Province ', '', 'ZIMBABWE', false, true, 'destiny-media/stays/35/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INCLUDES GUIDE
PARK FEES AND REFRESHMENTS', 'MATOBO DISTRICT', 'MATOBO DISTRICT', 'ZIMBABWE', false, true, 'destiny-media/stays/33/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
', 'HWANGE', 'HWANGE DISTRICT', 'ZIMBABWE', false, true, 'destiny-media/stays/32/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
COURTYARD', 'NUNGWI', 'NUNGWI', 'TANZANIA', false, true, 'destiny-media/stays/30/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
NIGHT GAME DRIVE
GUIDED WALK
FREE FISHING( BRING OWN BAIT AND TACKLE)', 'MATOBO NATIONAL PARK', 'MATOBO DISTRICT', 'ZIMBABWE', false, true, 'destiny-media/stays/29/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
SUNSET CRUISE
CULTURAL TOUR', 'BINGA', 'BINGA', 'ZIMBABWE', false, true, 'destiny-media/stays/28/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
BOATCRUISE
SPEED BOAT RIDE
TARGET SHOTING (ARCHERY)', 'BINDURA', 'BINDURA', 'ZIMBABWE', false, true, 'destiny-media/stays/27/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
', 'EGYPT', '', 'EGYPT', false, true, 'destiny-media/stays/26/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
PRIVATE KITCHEN
TOILETRIES
SELF CATERING', '1 Nzou Drive, Kariba', 'KARIBA', 'ZIMBABWE', false, true, 'destiny-media/stays/24/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
VALIDITY: 1ST OCT 2026 TO 10 JAN 2027', 'TSOWA SAFARI', 'ZAMBEZI NATIONA PARK', 'ZIMBABWE', false, true, 'destiny-media/stays/23/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
NOTE: SUBJECT TO FLUCTUATIONS', '1 Lagoon Gate Drive Cape Town 7441', 'CAPE TOWN', 'SOUTH AFRICA', false, true, 'destiny-media/stays/22/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
NOTE :
NEW BOOKINGS ONLY
SUBJECTTO AVAIABILITY AND FLUCTUATION OF RATES', 'VICTORIA FALLS', 'VICTORIA FALLS', '', false, true, 'destiny-media/stays/20/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
PACKAGE 2 : SUNDAY NIGHT TO MONDAY NIGHT', 'KUIMBA SHIRI', 'ZVIMBA', 'ZIMBABWE', false, true, 'destiny-media/stays/19/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
BREAKFAST
HALF DAY CITY TOUR
', '149 Marine Parade Durban 4001', 'DURBAN', 'SOUTH AFRICA', false, true, 'destiny-media/stays/18/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INCLUSIVE OF :
ACCOMMODATION
BREAKFAST', 'MUTOKO', 'MUTOKO', 'ZIMBABWE', false, true, 'destiny-media/stays/16/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
', 'NYANGA', 'NYANGA', 'ZIMBABWE', false, true, 'destiny-media/stays/14/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
ALL MEALS', 'Linga Linga, Morrumbene 1308', 'MAPUTO', 'MOZAMBIQUE', false, true, 'destiny-media/stays/11/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
1 NIGHT/ 2 DAYS- USD198 PER COUPLE ', 'GREAT ZIMBABWE HOTEL', 'MASVINGO', 'Zimbabwe', false, true, 'destiny-media/stays/10/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
DINNER CRUISE 
PARK FEE
1ST NOV TO 20TH DEC 2026 ', 'VICTORIA FALLS ', 'VICTORIA FALLS', 'Zimbabwe', false, true, 'destiny-media/stays/9/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
BREAKFAST
', 'VICTORIA FALLS ', 'VICTORIA FALLS', 'Zimbabwe', false, true, 'destiny-media/stays/8/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INSERT INTO public.stays (legacy_id, name, type, description, address, city, country, is_featured, is_published, primary_image_path, currency) VALUES (4, 'Troutbeck Resort Nyanga', 'Resort', 'Discover serene landscapes, tranquil lakes, and warm hospitality. $240 per night double room (2 adults) - Bed & breakfast. Alot of activities for an extra charge.', '', 'Nyanga', 'Zimbabwe', false, true, 'destiny-media/stays/4/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.stays (legacy_id, name, type, description, address, city, country, is_featured, is_published, primary_image_path, currency) VALUES (5, 'Musumu River Lodge', 'Lodge', 'Escape to Paradise! Discover Musumu River Lodges Binga! Breathtaking Views. Stunning Sunsets, Amazing wildlife, Luxurious Accommodation.', '', 'Binga', 'Zimbabwe', true, true, 'destiny-media/stays/5/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
Contact us now on reservations@destinytravelzim.com  or call +263242308326/346 or whatsap +263772375941', '', 'Binga', 'Zimbabwe', true, true, 'destiny-media/stays/2/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.stays (legacy_id, name, type, description, address, city, country, is_featured, is_published, primary_image_path, currency) VALUES (3, 'Sable Sands Safari Camp', 'Tented Camp', 'An authentic tented camp experience in a private concession bordering Hwange National Park.', 'Hwange Private Concession', 'Hwange', 'Zimbabwe', true, true, 'destiny-media/stays/3/primary.webp', 'USD') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, type=EXCLUDED.type, description=EXCLUDED.description, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/37/primary.webp', 'uploads/6a54c1b399064-616835563_1664833494489152_6348076497884262295_n.jpg', 0 FROM public.stays WHERE legacy_id=37;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/36/primary.webp', 'uploads/6a4f9dd72fab2-615471192_1663083854664116_2649064526261562484_n.jpg', 0 FROM public.stays WHERE legacy_id=36;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/35/primary.webp', 'uploads/6a4f9b8069725-615434009_1663086194663882_123611080104403035_n.jpg', 0 FROM public.stays WHERE legacy_id=35;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/33/primary.webp', 'uploads/6a4f5b6c2af0b-616827839_1669620824010419_5039646770684918639_n.jpg', 0 FROM public.stays WHERE legacy_id=33;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/32/primary.webp', 'uploads/6a4f5a8df12bd-626999792_1681118199527348_8781928959766861665_n.jpg', 0 FROM public.stays WHERE legacy_id=32;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/31/primary.webp', 'uploads/6a4f593b357f3-627143344_1682877346018100_4256269271618478209_n.jpg', 0 FROM public.stays WHERE legacy_id=31;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/30/primary.webp', 'uploads/6a4f5851324d7-626158837_1682879592684542_3549665868704782837_n.jpg', 0 FROM public.stays WHERE legacy_id=30;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/29/primary.webp', 'uploads/6a4f57861b988-639991094_1696240514681783_1183523098736264155_n.jpg', 0 FROM public.stays WHERE legacy_id=29;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/28/primary.webp', 'uploads/6a4f56c33b8ef-639229923_1696241041348397_4416506335286417851_n.jpg', 0 FROM public.stays WHERE legacy_id=28;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/27/primary.webp', 'uploads/6a4f553251c63-641399392_1699904650982036_9069118774992262354_n.jpg', 0 FROM public.stays WHERE legacy_id=27;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/26/primary.webp', 'uploads/6a4e48ed3217b-651035371_1713846052921229_6431422086256641855_n.jpg', 0 FROM public.stays WHERE legacy_id=26;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/24/primary.webp', 'uploads/6a4e444e2acef-651751033_1717060289266472_8582386724155725165_n.jpg', 0 FROM public.stays WHERE legacy_id=24;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/23/primary.webp', 'uploads/6a4e4379acf58-653704075_1719141525725015_9167148484667333969_n.jpg', 0 FROM public.stays WHERE legacy_id=23;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/22/primary.webp', 'uploads/6a4e415833cf9-656647058_1722145902091244_4829004906901322191_n.jpg', 0 FROM public.stays WHERE legacy_id=22;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/21/primary.webp', 'uploads/6a4e3f81708b8-ChatGPT Image Jul 8, 2026, 02_08_19 PM.png', 0 FROM public.stays WHERE legacy_id=21;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/20/primary.webp', 'uploads/6a4e3f7c569dc-ChatGPT Image Jul 8, 2026, 02_08_19 PM.png', 0 FROM public.stays WHERE legacy_id=20;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/19/primary.webp', 'uploads/6a4e1bd3db9a2-657163835_1722491342056700_4321707265649208640_n.jpg', 0 FROM public.stays WHERE legacy_id=19;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/18/primary.webp', 'uploads/6a4e194647330-656312260_1724773688495132_1174615719230396529_n.jpg', 0 FROM public.stays WHERE legacy_id=18;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/16/primary.webp', 'uploads/6a4e1337034cf-675020679_1746704992968668_8195398866841603539_n.jpg', 0 FROM public.stays WHERE legacy_id=16;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/14/primary.webp', 'uploads/6a4e12308366a-678655289_1747526919553142_1804452063333086943_n.jpg', 0 FROM public.stays WHERE legacy_id=14;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/13/primary.webp', 'uploads/6a4e0ddb08cad-677055824_1747531492886018_465792238771702595_n.jpg', 0 FROM public.stays WHERE legacy_id=13;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/12/primary.webp', 'uploads/6a4e0d8aeab65-679081833_1747531572886010_8241190597285094904_n.jpg', 0 FROM public.stays WHERE legacy_id=12;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/11/primary.webp', 'uploads/6a4e0c9750e3d-677063597_1748458519459982_4606751693495945160_n.jpg', 0 FROM public.stays WHERE legacy_id=11;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/10/primary.webp', 'uploads/6a4e0baa55e73-684908563_1754812892157878_7537154398826253792_n.jpg', 0 FROM public.stays WHERE legacy_id=10;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/9/primary.webp', 'uploads/6a4e0ac5230f9-690178754_1762327108073123_5929880093508995947_n.jpg', 0 FROM public.stays WHERE legacy_id=9;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/8/primary.webp', 'uploads/6a4e0973085fc-701757966_1771935113778989_4758451502969602632_n.jpg', 0 FROM public.stays WHERE legacy_id=8;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/6/primary.webp', 'uploads/6a4e07a5c61d1-729186459_1806601646979002_8901278662318032669_n.jpg', 0 FROM public.stays WHERE legacy_id=6;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/4/primary.webp', 'uploads/69fc507b55985-e96a075e-bb9a-4d72-a1a4-6ea8ec26b059.jpeg', 0 FROM public.stays WHERE legacy_id=4;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/4/gallery-01.webp', 'uploads/69fdb8cd0328a-e96a075e-bb9a-4d72-a1a4-6ea8ec26b059.jpeg', 1 FROM public.stays WHERE legacy_id=4;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/5/primary.webp', 'uploads/IMG-20250902-WA0009.jpg', 0 FROM public.stays WHERE legacy_id=5;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/1/gallery-01.webp', 'uploads/68e49df50379e-kariba2.jpg', 1 FROM public.stays WHERE legacy_id=1;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/1/gallery-02.webp', 'uploads/68e49df5038d3-kariba3.jpg', 2 FROM public.stays WHERE legacy_id=1;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/2/primary.webp', 'uploads/68e49f8880332-musumuriverlodgebinga.jpg', 0 FROM public.stays WHERE legacy_id=2;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/2/gallery-01.webp', 'uploads/68e49f88805e8-musumu1.jpg', 1 FROM public.stays WHERE legacy_id=2;
...
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/3/primary.webp', 'uploads/68c222ad3cd52-sable1.jpg', 0 FROM public.stays WHERE legacy_id=3;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/3/gallery-01.webp', 'uploads/68c222ad3d0a0-sa2.jpg', 1 FROM public.stays WHERE legacy_id=3;
INSERT INTO public.stay_images (stay_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/stays/3/gallery-02.webp', 'uploads/68c222ad3d18b-sa3.jpg', 2 FROM public.stays WHERE legacy_id=3;
...
INSERT INTO public.vehicles (legacy_id, make, model, year, type, price_per_day, currency, address, city, country, is_featured, is_published, primary_image_path) VALUES (2, 'Toyota', 'Corolla', 2022, 'Sedan', 60.0, 'USD', '55 Harare Drive', 'Harare', 'Zimbabwe', true, true, 'destiny-media/vehicles/2/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET make=EXCLUDED.make, model=EXCLUDED.model, year=EXCLUDED.year, type=EXCLUDED.type, price_per_day=EXCLUDED.price_per_day, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.vehicles (legacy_id, make, model, year, type, price_per_day, currency, address, city, country, is_featured, is_published, primary_image_path) VALUES (3, 'Mercedes-Benz', 'Sprinter', 2021, 'Shuttle', 150.0, 'USD', '12 Airport Road', 'Harare', 'Zimbabwe', true, true, 'destiny-media/vehicles/3/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET make=EXCLUDED.make, model=EXCLUDED.model, year=EXCLUDED.year, type=EXCLUDED.type, price_per_day=EXCLUDED.price_per_day, address=EXCLUDED.address, city=EXCLUDED.city, country=EXCLUDED.country, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INSERT INTO public.vehicle_images (vehicle_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/vehicles/2/primary.webp', 'uploads/68c2237c7a4da-co1.avif', 0 FROM public.vehicles WHERE legacy_id=2;
...
INSERT INTO public.vehicle_images (vehicle_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/vehicles/3/primary.webp', 'uploads/68c223a6319a8-sprint1.avif', 0 FROM public.vehicles WHERE legacy_id=3;
INSERT INTO public.vehicle_images (vehicle_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/vehicles/3/gallery-01.webp', 'uploads/68c223a631ac7-sprint2.jpeg', 1 FROM public.vehicles WHERE legacy_id=3;
...
INSERT INTO public.awards (legacy_id, name, description, year, is_published, primary_image_path) VALUES (5, 'ZNCC Micro Entrepreneur Award - Winner', 'Awarded to Kudzai Mundangepfupu, Destiny Travel, by the Zimbabwe National Chamber of Commerce.', 2025, true, 'destiny-media/awards/5/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, year=EXCLUDED.year, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.awards (legacy_id, name, description, year, is_published, primary_image_path) VALUES (6, 'Women in Enterprise Award - 1st Runner Up', 'Tourism Category, awarded to Kudzai Mundangepfupfu.', 2025, true, 'destiny-media/awards/6/primary.webp') ON CONFLICT (legacy_id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, year=EXCLUDED.year, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INSERT INTO public.award_images (award_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/awards/5/primary.webp', 'uploads/IMG-20251010-WA0025.jpg', 0 FROM public.awards WHERE legacy_id=5;
INSERT INTO public.award_images (award_id, storage_path, legacy_url, sort_order) SELECT id, 'destiny-media/awards/6/primary.webp', 'uploads/IMG-20251010-WA0024.jpg', 0 FROM public.awards WHERE legacy_id=6;
