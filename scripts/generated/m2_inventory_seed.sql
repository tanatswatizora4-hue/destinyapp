...
-- Generated by scripts/generate_m2_operator_artifacts.py from live:bymapara
...
', 1480, 'USD', '7 NIGHTS 8 DAYS', false, true, 'destiny-media/tours/39/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
EXCLUSIVE OF :
LUNCH AND TRANSPORT', 35, 'USD', 'DAY', false, true, 'destiny-media/tours/38/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
', 2780, 'USD', '5 NIGHTS 6 DAYS', false, true, 'destiny-media/tours/37/primary.png') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
RATE', 5600, 'USD', '7 NIGHTS 8 DAYS', false, true, 'destiny-media/tours/36/primary.png') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
NOTE: PACKAGE RATES ARE SUBJECTED TO FLUCTUATIONS', 4610, 'USD', 'N/A', false, true, 'destiny-media/tours/34/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
HOUSEBOAT CRUISE
ACTVITIES 
HORSE RIDING FOR ADULTS', 40, 'USD', 'DAY', false, true, 'destiny-media/tours/33/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (32, 'ZAMBEZI ARK CRUISES', 'USD75 INCLUDING PARKING SPCE ', 75, 'USD', 'N/A', false, true, 'destiny-media/tours/32/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
as extra.', 210, 'USD', '15-minute scenic flight', false, true, 'destiny-media/tours/31/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (30, 'Zanzibar (Beaches &amp; Island Escapes)', 'Flights from $590', 590, 'USD', '5', false, true, 'destiny-media/tours/30/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
Book by 12 Jul 2026; travel 25 Jun–30 Sept 2026.', 0, 'USD', 'Stopover offer', false, true, 'destiny-media/tours/29/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (15, 'Israel Holy Land Tour', 'A spiritual journey to the Holy Land. Includes VISA, return flights, all meals, 7 nights accommodation, and all tours and transfers.', 3023, 'USD', '8 Days, 7 Nights', true, true, 'destiny-media/tours/15/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (16, 'Zanzibar Trip', 'Includes return flight, airport transfers, 3 nights at Nungwi Beach Resort, daily breakfast, and an island tour.', 1030, 'USD', '4 Days, 3 Nights', true, true, 'destiny-media/tours/16/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (17, 'Malawi Trip', 'Includes 3 nights @ Sunbird Hotel, Breakfast, Hotel transfer, Boat cruise, Jet ski, and Return flights.', 1530, 'USD', '4 Days, 3 Nights', true, true, 'destiny-media/tours/17/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (18, 'Durban to Mozambique Cruise', '15 - 19 December 2025. Durban >> Pomene >> back to Durban. Includes return flight, 4 days accommodation, and all meals.', 1219, 'USD', '5 Days, 4 Nights', true, true, 'destiny-media/tours/18/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (19, 'Explore Singapore', '5 nights 6 days till 31st Sept 2025. Includes return flights, 5 nights accommodation, daily breakfast, Singapore City Tour, Wings Of Time with Cable Car, Madame Tussauds, Marina Bay Sands Sky Park, and all tours/transfers.', 1932, 'USD', '6 Days, 5 Nights', true, true, 'destiny-media/tours/19/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (20, 'Archipelago Resort Summer Escape', '3 nights bed and breakfast including return flights. Stay in spacious self-catering casas, dine at our seaside restaurant, dive, island-hop, or unwind.', 1150, 'USD', '4 Days, 3 Nights', false, true, 'destiny-media/tours/20/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (21, 'Bali Holiday Package', '6 Days 5 Nights. Includes return air tickets, 6 days and 5 nights at a 4* Hotel, AC transport, driver and tour guide, fast boat Bali - Nussa Penida return, breakfast, lunch and dinner, and entrance ticket.', 1990, 'USD', '6 Days, 5 Nights', true, true, 'uploads/IMG-20251025-WA0013.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (22, 'Girls Game Drive Retreat Kariba', 'August 10 to 11. Includes 1 night accommodation @ Spurwing Island, all meals, game drive, national park entry fees. *Excludes transport*.', 190, 'USD', '2 Days, 1 Night', false, true, 'destiny-media/tours/22/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (23, 'Musumu River Lodge Binga Tour', '2 nights 3 days (9 - 11 August). Includes breakfast and dinner, half-day guided tour, Tonga Museum, crocodile breeding, natural hot springs, sunset cruise. *Excludes transport*.', 460, 'USD', '3 Days, 2 Nights', false, true, 'destiny-media/tours/23/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (24, 'Figtree Camp Selous (Schools)', 'Two nights package. Primary schools $110, Secondary schools $115. Includes full board, 4 activities, 1 educational talk, team building, 1 free t-shirt.', 110, 'USD', '3 Days, 2 Nights', false, true, 'uploads/IMG-20251016-WA0002.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (14, 'Kadoma Music Festival 2025', 'Catch Africa''s best, Diamond Platnumz, blasting the stage with Zimbabwe''s own legends Alick Macheso, Winky D, Jah Prayzah, Saintfloew and Gemma Griffiths', 20, 'USD', '1 Night', true, true, 'destiny-media/tours/14/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (1, 'Victoria Falls Adventure', 'Experience the thrill of the mighty Victoria Falls. This package includes a guided tour of the falls, a sunset cruise on the Zambezi River, and a visit to a local craft market.', 1250, 'USD', '3 Days, 2 Nights', false, true, 'destiny-media/tours/1/primary.jpeg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (2, 'Durban To Mozambique Cruise', '"Embark on an unforgettable coastal odyssey with MSC. Book with us for a 5-day Durban to Mozambique cruise (Dec 15-19) and discover tropical bliss, vibrant cultures, and breathtaking scenery. Unleash your wanderlust!', 1219, 'USD', '3 Days, 1 Night', true, true, 'destiny-media/tours/2/primary.jpg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
INSERT INTO public.tours (legacy_id, title, description, price, currency, duration, is_featured, is_published, primary_image_path) VALUES (3, 'Hwange National Park Safari', 'Embark on an unforgettable wildlife safari in Zimbabwe''s largest national park. Search for the Big Five and enjoy the pristine African bush.', 1800, 'USD', '4 Days, 3 Nights', false, true, 'destiny-media/tours/3/primary.jpeg') ON CONFLICT (legacy_id) DO UPDATE SET title=EXCLUDED.title, description=EXCLUDED.description, price=EXCLUDED.price, duration=EXCLUDED.duration, is_featured=EXCLUDED.is_featured, is_published=EXCLUDED.is_published, primary_image_path=EXCLUDED.primary_image_path, updated_at=timezone('utc', now());
...
INSERT INTO public.stay_rooms (stay_id, name, price, capacity, sort_order) SELECT id, 'DOUBLE ROOM', 6800, 0, 0 FROM public.stays WHERE legacy_id=14;
...
INSERT INTO public.stay_rooms (stay_id, name, price, capacity, sort_order) SELECT id, 'Double Room', 240, 2, 0 FROM public.stays WHERE legacy_id=4;
...
INSERT INTO public.stay_rooms (stay_id, name, price, capacity, sort_order) SELECT id, 'Standard Queen Room', 150, 2, 0 FROM public.stays WHERE legacy_id=1;
INSERT INTO public.stay_rooms (stay_id, name, price, capacity, sort_order) SELECT id, 'Executive Suite', 250, 2, 1 FROM public.stays WHERE legacy_id=1;
INSERT INTO public.stay_rooms (stay_id, name, price, capacity, sort_order) SELECT id, 'Family Room', 220, 4, 2 FROM public.stays WHERE legacy_id=1;
...
INSERT INTO public.stay_rooms (stay_id, name, price, capacity, sort_order) SELECT id, 'River-Facing Double', 300, 2, 0 FROM public.stays WHERE legacy_id=2;
INSERT INTO public.stay_rooms (stay_id, name, price, capacity, sort_order) SELECT id, 'Luxury Tent', 450, 2, 1 FROM public.stays WHERE legacy_id=2;
...
INSERT INTO public.stay_rooms (stay_id, name, price, capacity, sort_order) SELECT id, 'Luxury Safari Tent', 550, 2, 0 FROM public.stays WHERE legacy_id=3;
