...
Last credential recheck (agent): 2026-09-09T00:04Z — still missing credentials; CLI `sb-login` awaiting code; watcher `m2-watch-apply` armed to auto-run apply when token appears; catalog HTTP 400.
