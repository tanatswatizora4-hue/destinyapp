...
Last credential recheck (agent): 2026-09-09T00:35Z — still missing credentials; drop-file `/tmp/destiny-m2.env` supported for VNC; watcher armed; catalog HTTP 400.
